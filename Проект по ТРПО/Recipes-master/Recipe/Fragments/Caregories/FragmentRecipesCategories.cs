...
namespace Recipe
{
    public class FragmentRecipesCategories : Android.Support.V4.App.Fragment
    {
        private View view;
        ...
        {
            view = inflater.Inflate(Resource.Layout.fragment_recipes_categories, container, false);
        ...
        private void SetupViewPager(Android.Support.V4.View.ViewPager viewPager)
        {
            ...
            var newFragment = new RecipeListFragment(recipeLinks.links[0].Item1, LoadType.LoadCategories, view);
